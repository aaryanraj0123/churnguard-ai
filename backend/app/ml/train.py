...
def train(
    ...
    if metrics["auc_roc"] >= best_auc and model_id:
        ...
        print("  [SKIPPED] Not better than existing model — keeping current active")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ChurnGuard AI — Training Pipeline (Phase 1+2)")
